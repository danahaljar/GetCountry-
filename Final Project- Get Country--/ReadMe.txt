...
-----------------------------------
This application will help the user to find out the country of any city. The user can simply enter the city and the application will display the country of that city. Also it stores the search history of the user.
